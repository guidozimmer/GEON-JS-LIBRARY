...
function createChart18Monate(canvasId, containerClass, firstdata18Monate, secondData18Monate, globalMaxValue) {
    ...
    document.getElementById(valueId1).innerHTML = `${firstdata18Monate[0]} <span style="font-size: smaller;">MW<sub>p</sub></span>`;
    document.getElementById(valueId2).innerHTML = `${secondData18Monate[0]} <span style="font-size: smaller;">MW<sub>p</sub></span>`;
...
function createChart36Monate(canvasId, containerClass, firstdata36Monate, secondData36Monate, globalMaxValue) {
    ...
    // Update the corresponding <h2> elements with the chart values
    document.getElementById(valueId1).innerHTML = `${firstdata36Monate[0]} <span style="font-size: smaller;">MW<sub>p</sub></span>`;
    document.getElementById(valueId2).innerHTML = `${secondData36Monate[0]} <span style="font-size: smaller;">MW<sub>p</sub></span>`;
